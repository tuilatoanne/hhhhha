...
module.exports.handleReaction = async function({ api, event, handleReaction }) {
	...
	api.sendMessage("Done box", handleReaction.pending);
...
module.exports.run = async function({ api, event, client }) {
	...
	return api.sendMessage(`Đang có tổng: ${list.length} nhóm đang trong tin nhắn spam cần bạn duyệt, hãy reactions tin nhắn bên dưới để duyệt!`, event.threadID, () => {
